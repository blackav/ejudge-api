...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/ej/api/v1/master/change-registration": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/ej/api/v1/master/copy-user-info": {
            "post": {
                ...
                "operationId": "master-post-copy-user-info",
                "parameters": [
                    {
                        "type": "string",
                        "description": "User login to copy info",
                        "name": "other_user_login",
                        "in": "formData"
                    },
                    {
                        "type": "integer",
                        "description": "User ID to copy info",
                        "name": "other_user_id",
                        "in": "formData"
                    },
                    {
                        ...
                        "name": "from_contest_id",
                        "in": "formData"
                    },
                    {
                        "type": "integer",
                        "description": "Destination contest ID",
                        "name": "to_contest_id",
                        "in": "formData"
                    }
                ],
        ...
        "/ej/api/v1/master/create-user-session": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "operationId": "master-post-create-user-session",
                "parameters": [
                    {
                        "type": "string",
                    ...
                    {
                        "type": "integer",
                        "description": "Session liveness duration",
                        "name": "duration",
                        "in": "formData"
                    },
                    {
                        "type": "boolean",
                        "description": "Create user registration if he/she is not registered",
                        "name": "create_reg",
                        "in": "formData"
                    },
                    {
                        "type": "integer",
                        "description": "Base Contest ID (to copy user settings from)",
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/ejudge.Reply-UserlistCookie"
                        }
                    },
                    "400": {
        ...
        "/ej/api/v1/master/get-user": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "User Login to query",
                        "name": "other_user_login",
                        "in": "query"
                    },
                    {
                        "type": "boolean",
                        "description": "Request global (not contest-specific) info",
                        "name": "global",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/ejudge.Reply-UserlistUser"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "ejudge.Reply-UserlistCookie": {
            ...
            "properties": {
                ...
                "result": {
                    "$ref": "#/definitions/ejudge.UserlistCookie"
                },
                "server_time": {
                    "type": "integer"
                }
        ...
        "ejudge.UserlistUser": {
            ...
            "properties": {
                "contests": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ejudge.UserlistUserContest"
                    }
                },
                "cookies": {
                    "type": "array",
                ...
                "infos": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ejudge.UserlistUserInfo"
                    }
                },
                "is_banned": {
                    "type": "boolean"
        ...
        "ejudge.UserlistUserInfo": {
            ...
            "properties": {
                ...
                "members": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ejudge.UserlistMember"
                    }
                },
                "phone": {
                    "type": "string"
